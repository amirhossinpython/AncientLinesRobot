...
@bot.on_message_updates(filters.text,filters.is_private,filters.Commands(['start']))
async def updates(update: Updates):
    await update.reply("سلام ربات تبدیل متن به خطوط باستانی  اماده برای کار است.")

@bot.on_message_updates(filters.is_private)
async def ancientline(update:Updates):
    ...
    await update.reply('**در حال تبدیل متن شما به خطوط باستانی..**')
    ...
    response = (
        ...
        f"متن به خط باستانی عبری :\n{hw}\n\n"
        f"متن به خط  میکنی:{linear_b_optimized}\n\n"
